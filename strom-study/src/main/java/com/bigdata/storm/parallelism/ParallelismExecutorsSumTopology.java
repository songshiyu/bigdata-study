 ...
 *
 *      调整strom Executors的数量
 */

public class ParallelismExecutorsSumTopology {
    ...
    public static void main(String[] args) throws InvalidTopologyException, AuthorizationException, AlreadyAliveException {
        ...
        topologyBuilder.setSpout("id_sum_spout", new SumSpout(),2);
        topologyBuilder.setBolt("bolt", new SumBolt(),2)
