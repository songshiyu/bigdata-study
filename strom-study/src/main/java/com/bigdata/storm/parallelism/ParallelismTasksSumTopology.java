...
public class ParallelismTasksSumTopology {
    ...
    public static void main(String[] args) throws InvalidTopologyException, AuthorizationException, AlreadyAliveException {
        ...
        /**
         * 在一个storm topology运行的生命周期的一个executor线程对应的task的数量是固定的
         * 但是在一个topology的executor的数目是可以动态修改的。默认是1:1
         * */
        TopologyBuilder topologyBuilder = new TopologyBuilder();
        topologyBuilder.setSpout("id_sum_spout", new SumSpout()).setNumTasks(2);
        topologyBuilder.setBolt("bolt", new SumBolt()).setNumTasks(3)
